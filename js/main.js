...
import { showModal, closeModal, onFormSubmit, blockSubmitButton } from './form.js';
...
onFormSubmit((data) => sendData(onSendSuccess, onSendError, data).finally(() => blockSubmitButton(false)));
